      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">Professional portfolio performance insights</p>
          </div>
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              >
                <option value="7d" className="bg-white text-gray-900">Last 7 days</option>
                <option value="30d" className="bg-white text-gray-900">Last 30 days</option>
                <option value="90d" className="bg-white text-gray-900">Last 90 days</option>
                <option value="1y" className="bg-white text-gray-900">Last year</option>
              </select>
            </div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-gray-900 font-semibold">{analyticsData.performance.lighthouseScore}/100</span>
                </div>
                <Progress value={analyticsData.performance.lighthouseScore} className="h-2" />
                
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">{analyticsData.performance.mobileScore}</div>
                    <div className="text-sm text-gray-600">Mobile</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">{analyticsData.performance.desktopScore}</div>
                ...
                {analyticsData.goals.goals.map((goal, index) => (
                  <div key={index} className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-gray-900 text-sm">{goal.value}/{goal.target}</span>
                    </div>
            ...
            <div className="space-y-4">
              {analyticsData.traffic.sources.map((source, index) => (
                <div key={index} className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-4">
                    <span className="text-gray-600">{source.views} views</span>
            ...
            <CardContent>
              <div className="space-y-4">
                {analyticsData.devices.devices.map((device, index) => (
                  <div key={index} className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      {device.device === 'Desktop' && <Monitor className="w-4 h-4 text-blue-600" />}
                      {device.device === 'Mobile' && <Smartphone className="w-4 h-4 text-green-600" />}
                      {device.device === 'Tablet' && <Monitor className="w-4 h-4 text-purple-600" />}
                      <span className="text-gray-900">{device.device}</span>
                    </div>
                    <div className="flex items-center space-x-4">
                      <span className="text-gray-600">{device.visitors}</span>
