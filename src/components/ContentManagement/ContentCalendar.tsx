...
const ContentCalendar: React.FC = () => {
    ...
    const mockPosts: ScheduledPost[] = [
      {
        ...
        content: 'Just updated my portfolio with new projects! Check out my latest work in AI and machine learning. #portfolio #ai #developer',
      ...
      },
      {
        id: '2',
        title: 'Tech Tips',
        content: '5 essential tips for React developers: 1. Use TypeScript 2. Implement proper error boundaries 3. Optimize with React.memo 4. Use custom hooks 5. Test your components',
      ...
      },
      {
        ...
        content: 'Excited to share my latest project - a full-stack e-commerce platform built with Next.js and Stripe!',
      ...
      },
      {
        id: '4',
        title: 'Weekly Update',
        content: 'This week I focused on learning advanced TypeScript patterns and implementing them in my projects.',
        platforms: ['twitter'],
        scheduledDate: new Date(Date.now() - 24 * 60 * 60 * 1000),
        scheduledTime: '10:00',
        status: 'published',
  ...
  const handleToggleAutoPost = (postId: string) => {
    setPosts(posts.map(p => 
      p.id === postId ? { ...p, autoPost: !p.autoPost } : p
    ));
  };
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        {post.scheduledDate.toLocaleDateString()} at {post.scheduledTime}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      {post.autoPost ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4" />}
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Posts will be published automatically at scheduled times</p>
                </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-medium text-blue-900">Next Auto-Post</span>
                </div>
                <p className="text-sm text-blue-800">
                  {getUpcomingPosts()[0]?.title || 'No posts scheduled'}
                </p>
                <p className="text-xs text-blue-600">
                  {getUpcomingPosts()[0]?.scheduledDate.toLocaleDateString() || ''} at {getUpcomingPosts()[0]?.scheduledTime || ''}
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['instagram', 'twitter', 'linkedin', 'youtube', 'facebook'].map((platform) => (
                    <Button
                      key={platform}
                      variant={newPost.platforms?.includes(platform as any) ? 'default' : 'outline'}
                      size="sm"
                      onClick={() => {
                        const platforms = newPost.platforms || [];
                        const updatedPlatforms = platforms.includes(platform as any)
