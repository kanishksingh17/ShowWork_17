...
interface TechStack {
  ...
  category: 'frontend' | 'backend' | 'database' | 'mobile' | 'devops' | 'language';
  color: string;
}
...
const TECH_STACKS: TechStack[] = [
  // Frontend Frameworks
  { id: 'react', name: 'React', icon: <Code2 className="w-5 h-5" />, category: 'frontend', color: 'bg-blue-500' },
  { id: 'vue', name: 'Vue.js', icon: <Layers className="w-5 h-5" />, category: 'frontend', color: 'bg-green-500' },
  { id: 'angular', name: 'Angular', icon: <Shield className="w-5 h-5" />, category: 'frontend', color: 'bg-red-500' },
  { id: 'nextjs', name: 'Next.js', icon: <Zap className="w-5 h-5" />, category: 'frontend', color: 'bg-gray-800' },
  { id: 'svelte', name: 'Svelte', icon: <Layers className="w-5 h-5" />, category: 'frontend', color: 'bg-orange-500' },
  { id: 'nuxt', name: 'Nuxt.js', icon: <Layers className="w-5 h-5" />, category: 'frontend', color: 'bg-green-600' },
  
  // Backend Technologies
  { id: 'nodejs', name: 'Node.js', icon: <Server className="w-5 h-5" />, category: 'backend', color: 'bg-green-600' },
  { id: 'express', name: 'Express.js', icon: <Server className="w-5 h-5" />, category: 'backend', color: 'bg-gray-700' },
  { id: 'nestjs', name: 'NestJS', icon: <Shield className="w-5 h-5" />, category: 'backend', color: 'bg-red-600' },
  { id: 'django', name: 'Django', icon: <Server className="w-5 h-5" />, category: 'backend', color: 'bg-green-700' },
  { id: 'flask', name: 'Flask', icon: <Server className="w-5 h-5" />, category: 'backend', color: 'bg-gray-600' },
  { id: 'fastapi', name: 'FastAPI', icon: <Zap className="w-5 h-5" />, category: 'backend', color: 'bg-teal-600' },
  { id: 'spring', name: 'Spring Boot', icon: <Layers className="w-5 h-5" />, category: 'backend', color: 'bg-green-500' },
  { id: 'dotnet', name: '.NET Core', icon: <Server className="w-5 h-5" />, category: 'backend', color: 'bg-purple-600' },
  
  // Programming Languages
  { id: 'html', name: 'HTML', icon: <Globe className="w-5 h-5" />, category: 'language', color: 'bg-orange-500' },
  { id: 'javascript', name: 'JavaScript', icon: <Terminal className="w-5 h-5" />, category: 'language', color: 'bg-yellow-400' },
  { id: 'typescript', name: 'TypeScript', icon: <Code2 className="w-5 h-5" />, category: 'language', color: 'bg-blue-600' },
  { id: 'python', name: 'Python', icon: <Brain className="w-5 h-5" />, category: 'language', color: 'bg-yellow-500' },
  { id: 'java', name: 'Java', icon: <Code2 className="w-5 h-5" />, category: 'language', color: 'bg-red-600' },
  { id: 'csharp', name: 'C#', icon: <Code2 className="w-5 h-5" />, category: 'language', color: 'bg-purple-500' },
  { id: 'go', name: 'Go', icon: <Zap className="w-5 h-5" />, category: 'language', color: 'bg-cyan-500' },
  { id: 'rust', name: 'Rust', icon: <Shield className="w-5 h-5" />, category: 'language', color: 'bg-orange-600' },
  { id: 'php', name: 'PHP', icon: <Globe className="w-5 h-5" />, category: 'language', color: 'bg-indigo-600' },
  
  // Mobile Development
  { id: 'reactnative', name: 'React Native', icon: <Code2 className="w-5 h-5" />, category: 'mobile', color: 'bg-blue-400' },
  { id: 'flutter', name: 'Flutter', icon: <Layers className="w-5 h-5" />, category: 'mobile', color: 'bg-blue-300' },
  { id: 'swift', name: 'Swift', icon: <Code2 className="w-5 h-5" />, category: 'mobile', color: 'bg-orange-500' },
  { id: 'kotlin', name: 'Kotlin', icon: <Code2 className="w-5 h-5" />, category: 'mobile', color: 'bg-purple-400' },
  
  // Databases
  { id: 'mongodb', name: 'MongoDB', icon: <Database className="w-5 h-5" />, category: 'database', color: 'bg-green-700' },
  { id: 'postgresql', name: 'PostgreSQL', icon: <Database className="w-5 h-5" />, category: 'database', color: 'bg-blue-700' },
  { id: 'mysql', name: 'MySQL', icon: <Database className="w-5 h-5" />, category: 'database', color: 'bg-orange-600' },
  { id: 'redis', name: 'Redis', icon: <Database className="w-5 h-5" />, category: 'database', color: 'bg-red-500' },
  { id: 'firebase', name: 'Firebase', icon: <Zap className="w-5 h-5" />, category: 'database', color: 'bg-yellow-600' },
  
  // DevOps & Cloud
  { id: 'docker', name: 'Docker', icon: <Layers className="w-5 h-5" />, category: 'devops', color: 'bg-blue-400' },
  { id: 'kubernetes', name: 'Kubernetes', icon: <Server className="w-5 h-5" />, category: 'devops', color: 'bg-blue-600' },
  { id: 'aws', name: 'AWS', icon: <Globe className="w-5 h-5" />, category: 'devops', color: 'bg-orange-500' },
  { id: 'gcp', name: 'Google Cloud', icon: <Globe className="w-5 h-5" />, category: 'devops', color: 'bg-blue-500' },
  { id: 'azure', name: 'Azure', icon: <Globe className="w-5 h-5" />, category: 'devops', color: 'bg-blue-600' },
  { id: 'vercel', name: 'Vercel', icon: <Zap className="w-5 h-5" />, category: 'devops', color: 'bg-gray-800' },
  { id: 'netlify', name: 'Netlify', icon: <Globe className="w-5 h-5" />, category: 'devops', color: 'bg-teal-500' },
];
...
const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: ['Hooks', 'Context API', 'Higher-Order Components', 'Render Props', 'Custom Hooks']
  },
  {
    id: 'react-3',
    techId: 'react',
    ...
    type: 'multiple-choice',
    options: ['Single Page Applications', 'E-commerce Sites', 'Admin Dashboards', 'Social Media Apps', 'Portfolio Sites']
  },
  ...
  },
  {
    ...
    type: 'multiple-choice',
    options: ['REST APIs', 'GraphQL APIs', 'Microservices', 'Real-time Applications', 'CLI Tools']
  },
  ...
  },
  {
    ...
    type: 'multiple-choice',
    options: ['Web Development', 'Data Science', 'Machine Learning', 'Automation/Scripting', 'API Development']
  },
  {
    id: 'python-3',
    techId: 'python',
  ...
  },
  {
    ...
    type: 'multiple-choice',
    options: ['Type Annotations', 'Interfaces', 'Generics', 'Union Types', 'Decorators']
  },
  ...
  },
  {
    ...
    type: 'multiple-choice',
    options: ['Semantic Elements', 'Forms & Validation', 'APIs (Canvas, Geolocation)', 'Accessibility (ARIA)', 'Web Components']
  },
  {
    id: 'html-3',
    techId: 'html',
    ...
    type: 'multiple-choice',
    options: ['Landing Pages', 'Web Applications', 'Email Templates', 'Documentation Sites', 'E-commerce Sites']
  },
  ...
  },
  {
    ...
    type: 'multiple-choice',
    options: ['Aggregation Pipeline', 'Indexing', 'Sharding', 'Replication', 'GridFS']
  },
  ...
  },
  {
    ...
    type: 'multiple-choice',
    options: ['Development Environment', 'Production Deployment', 'CI/CD Pipelines', 'Microservices', 'Testing']
  },
  ...
  },
  {
    ...
    type: 'multiple-choice',
    options: ['Server-Side Rendering', 'Static Site Generation', 'API Routes', 'Image Optimization', 'App Router']
  }
];
...
export default function DeveloperProfileSetup({ user, onComplete }: DeveloperProfileSetupProps = {}) {
  ...
  useEffect(() => {
    if (user) {
      ...
      const suggestedUsername = user.username || (user.name ? 
  ...
  // Navigation handlers
  const nextStep = () => {
    console.log('🔄 nextStep called - currentStep:', currentStep, 'selectedTechStacks:', selectedTechStacks.length);
    if (currentStep === 0) {
      ...
      if (selectedTechStacks.length > 0) {
        ...
        console.log('⏭️ Skipping quiz - no tech stacks selected, moving to step 3');
        setCurrentStep(3);
      }
  ...
  const canProceed = () => {
    console.log('canProceed check - currentStep:', currentStep, 'showSkillAssessmentIntro:', showSkillAssessmentIntro);
    if (showSkillAssessmentIntro) {
    ...
    if (currentStep === 0) {
      ...
      const canProceedStep0 = profileData.username && 
    ...
    if (currentStep === 1) {
      ...
      console.log('Step 1 canProceed:', canProceedStep1, 'selectedTechStacks:', selectedTechStacks.length);
    ...
    if (currentStep === 3) {
      ...
      console.log('Step 3 (final) - allowing proceed, selectedPlatforms:', selectedPlatforms.length);
  ...
  const renderProfileStep = () => (
    <div className="space-y-8">
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-600 text-lg">Let's start with your essential details</p>
        {user && (
          <div className="bg-green-50 border border-green-200 rounded-xl p-4 max-w-md mx-auto">
            <div className="flex items-center justify-center space-x-2 mb-2">
              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              <span className="text-green-700 font-medium text-sm">Pre-filled from Google</span>
            </div>
            <p className="text-green-600 text-xs">
              We've automatically filled in your details from your Google account to save you time!
            </p>
          </div>
        )}
      </div>
      ...
      <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-500">
            Your username is required and will be displayed in your public profile. It must be unique.
          </p>
  ...
  const renderSkillAssessmentIntro = () => {
    ...
    const selectedTechNames = selectedTechStacks.map(techId => {
      ...
      <div className="space-y-8">
        <div className="text-center space-y-6">
          <div className="space-y-4">
            ...
            <h3 className="text-xl font-semibold text-green-600">Validate Your Expertise</h3>
          </div>
          
          <div className="space-y-6">
            <p className="text-gray-600 text-lg leading-relaxed">
              Thank you for sharing your tech stack. To further personalize your experience, 
              we'd like to assess your skills in the technologies you selected.
            </p>
            
            <p className="text-gray-600 text-lg leading-relaxed">
              You'll be presented with one short question for each selected technology. 
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h5 className="text-lg font-semibold text-gray-900">One question at a time</h5>
            </div>
            <p className="text-gray-600">Each technology will have its own question.</p>
          </div>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-2xl p-6">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h5 className="text-lg font-semibold text-gray-900">Tailored feedback</h5>
            </div>
            <p className="text-gray-600">Your responses help us curate content and opportunities that match your skills.</p>
          </div>
        </div>
        ...
        <div className="text-center space-y-6">
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <h4 className="text-2xl font-bold text-gray-900 mb-4">Ready to begin?</h4>
  ...
  const renderTechStackSelection = () => {
    ...
    const groupedTechStacks = Object.entries(categories).map(([categoryKey, categoryName]) => ({
      name: categoryName,
      technologies: TECH_STACKS.filter(tech => tech.category === categoryKey)
    }));

    return (
      <div className="space-y-10">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Choose Your Tech Stack</h2>
          <p className="text-gray-600 text-lg">Select the technologies you work with. This helps us personalize your experience.</p>
        </div>
                  ...
                  return (
                    ...
                    >
                      <div className={`flex items-center justify-center w-6 h-6 rounded-lg transition-all duration-300 ${
                        isSelected ? 'bg-white/20 text-white' : 'bg-gray-100 text-gray-600 group-hover:text-gray-700'
                      }`}>
                        {tech.icon}
                      </div>
    ...
    if (!currentQuestion) {
      return (
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600">You've answered all the questions for your selected technologies.</p>
        </div>
      );
    }
  ...
  const renderPlatformSelection = () => (
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-gray-600 text-lg">Choose where you want to showcase your work</p>
      </div>
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-2/5 bg-gradient-to-br from-[#1E293B] via-[#1E40AF] to-[#0F172A] p-8 flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/80 text-lg leading-relaxed">
              Complete your developer profile in 4 easy steps to showcase your skills and connect with opportunities.
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          {[
            { number: 1, title: 'Basic Information', description: 'Username and personal details', icon: <Users className="w-5 h-5" /> },
            { number: 2, title: 'Tech Stack', description: 'Select your technologies', icon: <Code2 className="w-5 h-5" /> },
            { number: 3, title: 'Skill Assessment', description: 'Quick skill evaluation', icon: <Brain className="w-5 h-5" /> },
            { number: 4, title: 'Platform Selection', description: 'Choose your platforms', icon: <Globe className="w-5 h-5" /> }
          ].map((step, index) => {
            const isActive = !showSkillAssessmentIntro && currentStep === index;
            const isCompleted = !showSkillAssessmentIntro && currentStep > index;
              ...
              <div key={step.number} className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className={`font-semibold transition-colors duration-300 ${
                    isActive || isCompleted || isIntroActive ? 'text-white' : 'text-white/60'
                  }`}>
                    {step.title}
                  </h3>
                  <p className={`text-sm transition-colors duration-300 ${
                    isActive || isCompleted || isIntroActive ? 'text-white/80' : 'text-white/40'
                  }`}>
                    {step.description}
                  </p>
                </div>
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between text-white/80 text-sm mb-2">
            <span>Progress</span>
            <span>
              {showSkillAssessmentIntro ? '50%' :
               currentStep === 0 ? '25%' :
               currentStep === 1 ? '50%' :
               currentStep === 2 ? `${50 + (calculateQAProgress() * 0.25)}%` :
               '100%'
              }
            </span>
          </div>
          <div className="w-full h-2 bg-white/20 rounded-full overflow-hidden">
            <div 
              ...
              style={{ 
                width: showSkillAssessmentIntro ? '50%' :
                       currentStep === 0 ? '25%' :
                       currentStep === 1 ? '50%' : 
                       currentStep === 2 ? `${50 + (calculateQAProgress() * 0.25)}%` :
                       '100%'
      ...
      <div className="flex-1 bg-gray-50 flex flex-col">
        ...
        <div className="flex-1 p-8 overflow-y-auto">
          <div className="max-w-2xl mx-auto">
            {(() => {
              console.log('🎨 Rendering content - showSkillAssessmentIntro:', showSkillAssessmentIntro, 'currentStep:', currentStep);
              if (showSkillAssessmentIntro) {
        ...
        <div className="border-t border-gray-200 bg-white p-6">
          <div className="max-w-2xl mx-auto flex justify-between items-center">
            ...
            >
              ...
              {showSkillAssessmentIntro ? 'Back to Tech Stack' : currentStep === 0 ? 'Dashboard' : 'Previous'}
            </button>
                    ...
                    setTimeout(async () => {
                      try {
                        ...
                        if (response.ok) {
                          ...
                          console.log('Background API call failed:', response.status);
                        }
                      } catch (error) {
