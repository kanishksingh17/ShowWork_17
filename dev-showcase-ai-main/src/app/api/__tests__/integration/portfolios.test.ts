...
describe("/api/portfolios Integration Tests", () => {
  ...
  describe("GET /api/portfolios", () => {
    it("should list portfolios with pagination", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/portfolios?page=1&limit=10",
        {
          method: "GET",
          headers: {
    ...
    it("should handle pagination parameters", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/portfolios?page=2&limit=5&sort=title&order=asc",
        {
          method: "GET",
          headers: {
            authorization: "Bearer valid-token",
    ...
    it("should return validation error for invalid pagination", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/portfolios?page=0&limit=200",
        {
          method: "GET",
          headers: {
            authorization: "Bearer valid-token",
  ...
  describe("PATCH /api/portfolios/[id]/publish", () => {
    it("should publish portfolio successfully", async () => {
      const portfolioId = "1";
      const request = new NextRequest(
        `http://localhost:3000/api/portfolios/${portfolioId}/publish`,
        {
          method: "PATCH",
          headers: {
            authorization: "Bearer valid-token",
