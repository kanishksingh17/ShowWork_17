...
async function handleApiDocumentation(
  ...
  const documentation = {
    ...
    version: '1.0.0',
    description: 'Comprehensive API for AI-powered portfolio generation, management, and preview',
    ...
    endpoints: {
      '/api/generate': {
        ...
        requestBody: {
          ...
          properties: {
            type: {
              type: 'string',
              enum: ['hero', 'about', 'skills', 'projects', 'contact', 'testimonials', 'blog', 'seo'],
            ...
            userProfile: {
              ...
              properties: {
                ...
                style: { type: 'string', enum: ['professional', 'creative', 'minimalist', 'modern'] },
                colorPreferences: { type: 'array', items: { type: 'string', pattern: '^#[0-9A-Fa-f]{6}$' } },
            ...
            context: {
              ...
              properties: {
                ...
                tone: { type: 'string', enum: ['formal', 'casual', 'friendly', 'authoritative'] },
          ...
          response: {
            ...
            data: {
              ...
              metadata: {
                wordCount: 45,
                readingTime: 1,
                keywords: ['developer', 'web applications', 'React', 'Node.js', 'TypeScript', 'Python'],
                suggestions: ['Consider adding specific achievements or metrics', 'Include a call-to-action'],
                confidence: 92
              }
            },
            message: 'Content generated successfully',
      ...
      '/api/portfolios': {
        ...
        queryParameters: {
          ...
          sort: { type: 'string', enum: ['createdAt', 'updatedAt', 'title', 'views'], default: 'createdAt' },
          ...
          properties: {
            ...
            device: {
              ...
              properties: {
                ...
                pixelRatio: { type: 'number', minimum: 0.5, maximum: 4, default: 1 }
              }
            },
            ...
            pan: {
              type: 'object',
              properties: {
                x: { type: 'number', minimum: -1000, maximum: 1000, default: 0 },
                y: { type: 'number', minimum: -1000, maximum: 1000, default: 0 }
              }
            },
            options: {
              type: 'object',
          ...
          body: {
            ...
            data: {
              ...
              metadata: {
                wordCount: 52,
                readingTime: 1,
                keywords: ['UX Designer', 'digital experiences', 'Figma', 'Sketch', 'Adobe XD'],
                suggestions: ['Consider adding specific project examples', 'Include a personal touch'],
                confidence: 89
              }
            },
            message: 'Content generated successfully',
        ...
        response: {
          ...
          body: {
            ...
            data: {
              ...
              previewUrl: 'https://preview.example.com/123e4567-e89b-12d3-a456-426614174000',
...
preview = api.generate_preview(
  ...
  return createSuccessResponse(documentation, 'API documentation retrieved successfully')
}
