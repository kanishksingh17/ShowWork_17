        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#skills" className="text-gray-900 hover:text-blue-600">Skills</a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                ...
                web applications. I love creating solutions that make a difference in people's lives.
              </p>
              <p className="text-gray-600 mb-6">
                My expertise includes React, Node.js, Python, and cloud technologies. I'm always
            ...
            <div className="bg-gray-100 rounded-lg p-8">
              <h4 className="text-xl font-semibold text-gray-900 mb-4">Quick Stats</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                image: "https://via.placeholder.com/400x300/059669/FFFFFF?text=Task+App",
                technologies: ["Vue.js", "Express", "Socket.io"]
              },
              {
                title: "Portfolio Website",
                description: "A modern portfolio website with animations and responsive design",
                image: "https://via.placeholder.com/400x300/DC2626/FFFFFF?text=Portfolio",
      ...
      <div className="h-screen flex flex-col">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white p-4">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-2xl font-bold">Live Portfolio Preview System</h1>
            <p className="text-blue-100 mt-1">
              Real-time preview with WebSockets, multi-device support, and export functionality
            </p>
          </div>
        </div>
