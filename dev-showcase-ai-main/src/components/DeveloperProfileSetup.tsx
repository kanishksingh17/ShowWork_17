...
export default function DeveloperProfileSetup({ onComplete }: DeveloperProfileSetupProps = {}) {
  ...
  const nextStep = () => {
    if (currentStep === 0) {
      setCurrentStep(1);
    } else if (currentStep === 1 && selectedTechStacks.length > 0) {
      ...
      <div className="flex-1 bg-gray-50 flex flex-col">
        ...
        <div className="flex-1 p-8 overflow-y-auto">
          <div className="max-w-2xl mx-auto">
            {showSkillAssessmentIntro && renderSkillAssessmentIntro()}
            {!showSkillAssessmentIntro && currentStep === 0 && renderProfileStep()}
            {!showSkillAssessmentIntro && currentStep === 1 && renderTechStackSelection()}
            {!showSkillAssessmentIntro && currentStep === 2 && renderQuestionsStep()}
            {!showSkillAssessmentIntro && currentStep === 3 && renderPlatformSelection()}
          </div>
        </div>
