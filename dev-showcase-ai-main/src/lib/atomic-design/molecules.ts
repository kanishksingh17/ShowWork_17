import { MoleculeComponent, ComponentProp, ComponentStyle, AccessibilityConfig, ResponsiveConfig, ComponentMetadata, PerformanceMetrics, SEOConfig, MoleculeLayout, Interaction, AnimationConfig } from './types'
...
export function validateMoleculeProps(molecule: MoleculeComponent, props: Record<string, any>): boolean {
