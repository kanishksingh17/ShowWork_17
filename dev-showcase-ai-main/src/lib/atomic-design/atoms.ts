import { AtomComponent, AtomVariant, ComponentProp, ComponentStyle, AccessibilityConfig, ResponsiveConfig, ComponentMetadata, PerformanceMetrics, SEOConfig } from './types'
...
export function createAtomVariant(atom: AtomComponent, variantName: string, styles: Record<string, any>, props: Record<string, any> = {}): AtomVariant {
  return {
    name: variantName,
    styles,
    props
...
export function validateAtomProps(atom: AtomComponent, props: Record<string, any>): boolean {
