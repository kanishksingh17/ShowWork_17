...
const skillSchema = new mongoose.Schema({
  ...
  category: { type: String, required: true, enum: ['programming', 'design', 'soft-skills', 'tools'] },
...
skillSchema.pre('save', function(next) {
  this.totalQuestions = this.easyQuestions + this.mediumQuestions + this.hardQuestions;
  next();
});
