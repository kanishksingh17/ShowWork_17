...
const skills = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "The <style> tag is used to define CSS styles that are embedded within the HTML document.",
        difficulty: "easy",
        points: 1,
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "The <br> tag is used to insert a single line break in HTML.",
        difficulty: "easy",
        points: 1,
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "The alt attribute provides alternative text for an image when the image cannot be displayed.",
        difficulty: "medium",
        points: 2,
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Semantic HTML uses meaningful tags that describe the content structure, making it more accessible and SEO-friendly.",
        difficulty: "hard",
        points: 3,
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "The email input type provides validation for email addresses and shows appropriate keyboard on mobile devices.",
        difficulty: "medium",
        points: 2,
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "The <article> element represents a self-contained composition that could be independently distributable or reusable.",
        difficulty: "hard",
        points: 3,
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "The font-size property controls the size of the text in CSS.",
        difficulty: "easy",
        points: 1,
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "The correct CSS syntax is h1 {background-color:#FFFFFF;} to add a background color to all h1 elements.",
        difficulty: "easy",
        points: 1,
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "The correct CSS syntax is p {font-weight:bold;} to make all paragraph elements bold.",
        difficulty: "medium",
        points: 2,
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "The text-transform:capitalize property makes each word start with a capital letter.",
        difficulty: "medium",
        points: 2,
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "The margin-left property is used to change the left margin of an element.",
        difficulty: "medium",
        points: 2,
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "The CSS box model describes how elements are laid out with margins, borders, padding, and content areas.",
        difficulty: "hard",
        points: 3,
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "position: relative positions the element relative to where it would normally be positioned.",
        difficulty: "hard",
        points: 3,
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "The .class selector is used to select elements with a specific class name.",
        difficulty: "medium",
        points: 2,
      },
    ],
    ...
    questions: [
      {
        ...
        correctAnswer: 2,
        explanation:
          'JavaScript does not have an "integer" type. It has "number" which represents both integers and floating-point numbers.',
        difficulty: "easy",
        points: 1,
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          'Arrays in JavaScript are written using square brackets: var colors = ["red", "green", "blue"]',
        difficulty: "easy",
        points: 1,
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Functions are called by writing the function name followed by parentheses: myFunction()",
        difficulty: "easy",
        points: 1,
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          '"use strict" enables strict mode which catches common coding mistakes and prevents some potentially confusing features.',
        difficulty: "medium",
        points: 2,
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          'The "this" keyword refers to the object that is currently executing the function, which can vary depending on how the function is called.',
        difficulty: "hard",
        points: 3,
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          '"==" performs type coercion and checks value, while "===" checks both value and type without coercion.',
        difficulty: "medium",
        points: 2,
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "async/await provides a more elegant way to handle asynchronous operations compared to using promises with .then() and .catch().",
        difficulty: "hard",
        points: 3,
      },
    ],
...
async function seedSkills() {
  try {
    ...
    insertedSkills.forEach((skill) => {
      console.log(
        `📚 ${skill.displayName}: ${skill.questions.length} questions`,
      );
    });
